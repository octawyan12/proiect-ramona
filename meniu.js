...
function McAcdnMenu(s){
	...
	},h="className",O=0,w="firstChild",
	j=function(b,c){
		var a=c==0?b.nextSibling:b[w];
		while(a&&a.nodeType!=1)
			a=a.nextSibling;
		return a
	},a="length",v="attachEvent",z="addEventListener",
	n=function(e){
